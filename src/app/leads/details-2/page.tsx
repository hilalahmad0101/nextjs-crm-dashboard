...
export default function LeadDetailsView2() {
  return (
    <>
      {/* Screen Content */}
      {/*  Header  */}
...
{/*  Activity Composer  */}
<div className="bg-white dark:bg-slate-800/40 rounded-xl border border-slate-200 dark:border-slate-800 p-1">
<div className="flex border-b border-slate-200 dark:border-slate-800">
<button className="px-4 py-3 text-sm font-bold text-primary border-b-2 border-primary">Log Note</button>
<button className="px-4 py-3 text-sm font-medium text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">Email</button>
<button className="px-4 py-3 text-sm font-medium text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">Call</button>
<button className="px-4 py-3 text-sm font-medium text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">Meeting</button>
</div>
<div className="p-4">
<textarea className="w-full bg-transparent border-none focus:ring-0 text-sm text-slate-700 dark:text-slate-200 placeholder:text-slate-500 resize-none" placeholder="Click to log a note about Sarah..." rows="3"></textarea>
